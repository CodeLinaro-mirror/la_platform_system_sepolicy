...
var (
	ServiceFuzzerBindings = map[string][]string{
		...
		"android.hardware.bluetooth.socket.IBluetoothSocket/lpp":                             []string{"android.hardware.bluetooth.socket-service_fuzzer"},
		"android.hardware.bluetooth.gatt.IBluetoothGatt/default":                             []string{"android.hardware.bluetooth.gatt-service_fuzzer"},
		...
		"android.hardware.motioncontext.IMotionContext/default":                              []string{"android.hardware.motioncontext-service_fuzzer"},
		...
		"android.hardware.security.sharedsecret.ISharedSecret/security_vm":                   EXCEPTION_NO_FUZZER,
		"android.hardware.security.timestamp.ITimeStamper/default":                           EXCEPTION_NO_FUZZER,
		...
		"android.trusty.provisioning.IProvisioning/security_vm_keymint":        EXCEPTION_NO_FUZZER,
		...
		"bluetooth_manager_ext":                                                EXCEPTION_NO_FUZZER,
		...
		"media.codeclist.generator":              EXCEPTION_NO_FUZZER,
		...
		"content_safety":                         EXCEPTION_NO_FUZZER,
		...
		"pcc_sandbox_native":                     EXCEPTION_NO_FUZZER,
